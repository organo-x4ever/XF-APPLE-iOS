...
namespace com.organo.x4ever
{
    public partial class MasterViewController : UITableViewController
    {
        ...
        {
            base.ViewDidLoad();
            leftBBI = new UIBarButtonItem("Stream a song", UIBarButtonItemStyle.Bordered, this,
                new Selector("StreamSong:"));
            NavigationItem.LeftBarButtonItem = leftBBI;
            rightBBI = new UIBarButtonItem("Now Playing", UIBarButtonItemStyle.Bordered, this,
                new Selector("NowPlaying:"));
        ...
        public override void ViewWillAppear(bool animated)
        {
            ...
            if (!Songs.searching)
                ...
                searchController.SearchResultsTableView.ReloadRows(
                    searchController.SearchResultsTableView.IndexPathsForVisibleRows, UITableViewRowAnimation.None);
        }
        ...
        public override void PrepareForSegue(UIStoryboardSegue segue, NSObject sender)
        {
            ...
            if (segue.Identifier == "showDetail")
            {
                ...
                {
                    // Selected song
                    NSIndexPath indexPath = Songs.searching
                        ? searchController.SearchResultsTableView.IndexPathForSelectedRow
        ...
        public void NowPlaying(UIBarButtonItem sender)
        {
            ...
            {
                UIAlertController ac = UIAlertController.Create("No songs playing", "Please select a song to play",
