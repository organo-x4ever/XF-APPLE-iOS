...
namespace com.organo.x4ever.ios.Handler
{
    public class VolumeButtonHandler : NSObject
    {
        ...
        public void Start()
        {
            ...
            DispatchQueue.DefaultGlobalQueue.DispatchAfter(new DispatchTime((Int64) 0.1f * 1000000),
                () => { setInitialVolume(); });
        ...
        private void initAudioSession()
        {
            ...
            if (errorOrNull != null)
            {
                throw new System.Exception(errorOrNull.Description);
            }
            ...
            NSNotificationCenter.DefaultCenter.AddObserver(AVAudioSession.InterruptionNotification,
