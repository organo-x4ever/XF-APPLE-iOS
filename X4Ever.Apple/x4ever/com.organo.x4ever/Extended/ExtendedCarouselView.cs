...
{
    public interface IExtendedCarouselPage
    {
    ...
    public class ExtendedCarouselView : ContentView
    {
        ...
        private bool _usingAltPage = false;
        private bool _initialised = false;
        private uint pageAnimationTime = 250;

        private Grid _baseLayout;
        private ContentView _mainPage;
        private ScrollView _mainPageSV;
        private ContentView _altPage;
        private ScrollView _altPageSV;

        private Rectangle _dimen;

        #endregion Setup for Carousel view
        ...
        public ExtendedCarouselView()
        {
            ...
            #endregion Carousel Base Layout
        }
        ...
        private void Page_Appearing(IExtendedCarouselPage page)
        {
            if (page != null)
            {
        ...
        private void Page_Appeared(IExtendedCarouselPage page)
        {
            if (page != null)
            {
                page.OnPageAppeared();
        ...
        private void Page_Disappearing(IExtendedCarouselPage page)
        {
            if (page != null)
            {
        ...
        private void Page_Disappeared(IExtendedCarouselPage page)
        {
            if (page != null)
            {
