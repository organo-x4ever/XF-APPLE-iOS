...
using com.organo.x4ever.Pages.Milestone;
using Xamarin.Forms;
...
namespace com.organo.x4ever.ViewModels.Profile
{
    public class ProfileEnhancedViewModel : BaseViewModel
    {
       ...
       private readonly PoundToKiligramConverter _converter = new PoundToKiligramConverter();
        ...
        private const string GaugeCurrentTextPropertyName = "GaugeCurrentText";

        public string GaugeCurrentText
        {
            get { return _gaugeCurrentText; }
            set { SetProperty(ref _gaugeCurrentText, value, GaugeCurrentTextPropertyName); }
        }
